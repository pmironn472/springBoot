...
@Route(value = "mgw", layout = MainLayout.class)
@PageTitle("Mgw Test Configuration")
public class MgwTestConfiguration extends VerticalLayout {
    ...
    public MgwTestConfiguration() {
        addClassName("mgw-conf");
        setSizeFull();
        add(engineerName());
        add(getToolbar());
    ...
    private HorizontalLayout getToolbar() {
        ...
        testTosTicket.setLabel("Test Ticket Mgw");
